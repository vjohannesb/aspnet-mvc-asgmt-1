    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthorization(options =>
            {
                ...
                options.AddPolicy("Teachers", policy => policy.RequireRole("Admin", "Teacher"));
                options.AddPolicy("Users", policy => policy.RequireRole("Admin", "Teacher", "Student"));
            });
